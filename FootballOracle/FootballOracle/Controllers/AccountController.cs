...
namespace FootballOracle.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            var teamsString = new List<SelectListItem>();

            this.teamService.GetAll().ToList().ForEach(x =>
            {
                teamsString.Add(new SelectListItem()
                {
                    Text = x.Name,
                    Value = x.Id.ToString()
                });
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser
                {
                    ...
                    City = model.City,
                    FavouriteTeamId = model.FavouriteTeamId,
                ...
                if (result.Succeeded)
                {
                    var userForecast = new UserForecast()
                    {
                        Id = Guid.NewGuid(),
                    ...
                    this.userForecastService.Create(userForecast);
